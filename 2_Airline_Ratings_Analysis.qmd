...
# renv::snapshot()
install.packages(c("tidyverse","ggplot2","dplyr","GGally","gapminder","png","sf","maps","rnaturalearth","ggthemes","vcd","psych","corrplot"))
library(tidyverse)
library(dplyr)
library(ggplot2)
library(GGally)
...
## Data Preparation 2.2 Retain one Dependent Variable
...
Throw: Score\>5&Rmd="no"; Score\<5&Rmd="yes";
...
## Data Preparation 2.2 Test Collinearity

ggpairs is not the best way due to the discrete nature of the dataset

change OverallScore from "0-10" to "0-5"
...
## Analysis 3.1 The proportion of services
...
# Add the total percentage of the top 20 airline services
...
## Analysis 3.3 Ratings in some countries
...
## Analysis 4.2 Rating trend of different type of services
...
## Analysis 4.3 Rating trend of different Travel Type
...
## Analysis 4.4 Rating trend of different Airlines
